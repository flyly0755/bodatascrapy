...
def main():
    ...
    time.sleep(5)
    target1 = driver.find_element_by_xpath('//*[@id="selDate_ListDay"]/div/div[85]/table/tbody/tr[1]/td[3]')
    driver.execute_script("arguments[0].scrollIntoView();", target1)
    time.sleep(5)
    driver.find_element_by_xpath('//*[@id="selDate_ListDay"]/div/div[85]/table/tbody/tr[4]/td[5]').click()
